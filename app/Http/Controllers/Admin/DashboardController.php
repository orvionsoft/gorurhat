...
class DashboardController extends Controller
{
    ...
    public function dashboard(){
        ...
        $latest_product = Product::latest()->limit(5)->with('category','image')->get();
        ...
        return view('backEnd.admin.dashboard',compact('total_order','today_order','total_product','total_customer','latest_order','latest_customer','latest_product','today_delivery','total_delivery','last_week','last_month','monthly_sale'));
    }
