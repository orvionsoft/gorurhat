...
class ReviewController extends Controller
{
    ...
    public function active(Request $request){
        ...
        // The product table does not store a "ratting" column.
        // Reviews are stored in the reviews table (ratting field), and the average
        // rating is calculated on-the-fly when needed.
