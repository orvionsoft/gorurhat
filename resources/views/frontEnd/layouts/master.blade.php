                    ...
                    <li class="parent-category">
                        ...
                        <ul class="second-nav" style="display: none;">
                            ...
                            <li class="parent-subcategory">
                                ...
                                <span class="menu-subcategory-toggle"><i class="bi bi-chevron-down"></i></span>
                                @endif
...
<nav class="responsive-navbar">
    ...
    <ul class="navbar-menu">
        <li><a href="{{ route('home') }}">হোমপেজ</a></li>
        <li><a href="{{ route('shop') }}">কোরবানির হাট</a></li>
...
<div class="mobile-overlay" id="mobileOverlay">
    <div class="mobile-menu-panel">
        <div class="mobile-menu-header">
            <img src="{{ asset($generalsetting->white_logo) }}" style="width: 230px" alt="Logo" class="mobile-logo">
            <button class="close-menu" id="closeMenuBtn">
                <i class="bi bi-x-lg"></i>
            </button>
        </div>
        <ul class="mobile-nav-items">
            <li><a href="{{ route('home') }}"><i class="bi bi-house-door-fill"></i> হোমপেজ</a></li>
            <li><a href="{{ route('shop') }}"><i class="bi bi-shop"></i> কোরবানির হাট</a></li>
            <li><a href="{{ route('contact') }}"><i class="bi bi-envelope-fill"></i> যোগাযোগ</a></li>
        </ul>
    </div>
</div>
    ...
    <div class="footer-grid">
        <div class="footer-about">
            <div class="logo-container">
                <img src="{{ asset($generalsetting->white_logo) }}" style="width: auto; max-width: 100%; height: auto;" alt="{{ $generalsetting->name }}">
            </div>
            <p style="color: #cccccc; line-height: 1.8; max-width: 520px; margin-top: 18px;">
                {{ $footer_setting->description ?? $generalsetting->description ?? 'আমাদের হাট থেকে সেরা কোরবানির পশু বেছে নিন।' }}
            </p>
            <div class="social-icons">
                @if($footer_setting->facebook_link)
                    <a href="{{ $footer_setting->facebook_link }}" target="_blank" class="social-icon" title="Facebook"><i class="bi bi-facebook"></i></a>
                @endif
                @if($footer_setting->youtube_link)
                    <a href="{{ $footer_setting->youtube_link }}" target="_blank" class="social-icon" title="YouTube"><i class="bi bi-youtube"></i></a>
                @endif
            </div>
        </div>
        <div class="footer-links">
            ...
            <ul>
                ...
                <li><a href="{{ route('shop') }}">কোরবানির হাট</a></li>
                <li><a href="{{ route('contact') }}">যোগাযোগ</a></li>
                <li><a href="{{ route('page', 'about') }}">আমাদের সম্পর্কে</a></li>
            </ul>
        </div>
        <div class="footer-contact">
            ...
            <div class="contact-card">
                ...
                <p style="margin: 0; font-size: 1rem; color: #ffffff;">{{ $footer_setting->phone_number ?? $contact->hotline ?? '+880 1234 567 890' }}</p>
            </div>
            <div class="contact-card" style="margin-top: 16px;">
                <p style="margin: 0 0 8px; color: #a7a7a7; font-size: 0.95rem;">ঠিকানা</p>
                <p style="margin: 0; font-size: 1rem; color: #ffffff;">{{ $footer_setting->address ?? $contact->address ?? 'বনানী, ঢাকা, বাংলাদেশ' }}</p>
            </div>
        </div>
    </div>
    <div style="padding-top: 18px; text-align: center; border-top: 1px solid #1a1a1a; margin-top: 30px;">
        <p style="color: #9e9e9e; margin: 0; font-size: 0.95rem; text-align: center;">© {{ date('Y') }} {{ $generalsetting->name }}. সর্বস্বত্ব সংরক্ষিত।</p>
    </div>
</footer>
