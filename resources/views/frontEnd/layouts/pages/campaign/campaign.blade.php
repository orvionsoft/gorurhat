    ...
    <head>
        ...
        <style>
            ...
            @keyframes colorAnimation {
                ...
                33% {
                    color: black; /* Transition to black */
                }
                66% {
                        ...
                        <div class="campaign_image">
                            <div class="campaign_item">
                                <div class="banner_t">
                                    ...
                                    <a href="#order_form" class="cam_order_now" id="cam_order_now"><i class="bi bi-cart-fill"></i> অর্ডার করুন </a>
        ...
        <section class="camp_video_sec">
            <div class="container">
                ...
                <div class="row justify-content-center gy-2 gy-md-4">
                    ...
                    <div class="col-sm-12">
                        <div class="ord_btn">
                            <a href="#order_form" class="cam_order_now" id="cam_order_now"> অর্ডার করতে ক্লিক করুন <i class="bi bi-hand-index-thumb-fill"></i> </a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row justify-content-center my-2 my-md-4 gy-2">
                            <div class="col-md-6 custom_btn">
                                <div class="shadow-lg">
                                    ...
                                    class="btn btn-danger btn-lg d-block py-md-3 fs-2 fw-bolder button-3d button-animated-border" >
                                        <i class="bi bi-telephone-fill"></i> আমাদের কল করুন </a>
                                </div>
                            ...
                            <div class="shadow-lg">
                                ...
                                class="btn btn-success btn-lg d-block py-md-3 fs-2 text-light fw-bolder button-3d button-animated-border">
                                    <i class="bi bi-whatsapp"></i> হোয়াটসঅ্যাপ  
                                    </a>
                             </div>
