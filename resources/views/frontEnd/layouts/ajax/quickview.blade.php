	...
	<div class="quick-product-content">
		<div class="product-details-cart">
            <p class="name">{{$data->name}}</p>
             <p style="display: none;" class="product_star"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i> ({{$data->reviews_count}} customer review)</p>
