                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{ asset(optional($generalsetting)->dark_logo ?: 'public/backEnd/assets/images/logo-dark.png') }}" alt="{{ optional($generalsetting)->name ?: 'Logo' }}" height="22">
                                            </span>
                                        </a>
                    
                                        <a href="" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="{{ asset(optional($generalsetting)->white_logo ?: 'public/backEnd/assets/images/logo-light.png') }}" alt="{{ optional($generalsetting)->name ?: 'Logo' }}" height="22">
                                            </span>
                                        </a>
                                    </div>
