...
@section('title','Footer Settings Manage')
@section('css')
<style>
        ...
        <div class="col-12">
            <div class="dashboard-panel">
                <div class="dashboard-panel-title">
                    ...
                    <a href="{{ route('footer.create') }}" class="btn-add-cow">Create Footer Settings</a>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="custom-btn-list">
                                    <a href="{{ route('footer.edit', $value->slug) }}" title="Edit"><i class="fe-edit-1"></i></a>
                                    <form method="post" action="{{ route('footer.destroy') }}" class="d-inline">
                                        @csrf
