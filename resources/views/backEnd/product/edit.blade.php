          ...
          <form action="{{route('products.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data" name="editForm">
            ...
            <div class="col-sm-3">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $edit_data->age }}" id="age" />
                @error('age')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-3">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('weight') is-invalid @enderror" name="weight" value="{{ $edit_data->weight }}" id="weight" />
                @error('weight')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-3">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('breed') is-invalid @enderror" name="breed" value="{{ $edit_data->breed }}" id="breed" />
                @error('breed')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-3">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('health') is-invalid @enderror" name="health" value="{{ $edit_data->health }}" id="health" />
                @error('health')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
