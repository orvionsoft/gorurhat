            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <form method="get" action="{{route('admin.order.cart_clear')}}" class="d-inline">
                        @csrf
                    <button type="submit" class="btn btn-danger rounded-pill delete-confirm" title="Delete"><i class="bi bi-trash"></i> Cart Clear</button></form>
                </div>
                        ...
                        <div class="col-sm-12">
                          <table class="table table-bordered table-responsive-sm">
                            ...
                            <tbody id="cartTable">
                              ...
                              <tr>
                                <td><img height="60" src="{{asset($value->options->image)}}"></td>
                                <td>{{$value->name}} 
                                @php
                               ...
                               @if($product && ($product->sizes->isNotEmpty() || $product->colors->isNotEmpty()))
                                ...
                                <td><button type="button" class="btn btn-danger btn-xs cart_remove" data-id="{{$value->rowId}}"><i class="bi bi-x"></i></button></td>
                              </tr>
                              @php
