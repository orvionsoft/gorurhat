                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <div class="export-print text-end">
                            <button onclick="printFunction()"class="no-print btn btn-success"><i class="bi bi-printer"></i> Print</button>
                            <button id="export-excel-button" class="no-print btn btn-info"><i class="bi bi-file-earmark-excel"></i> Export</button>
                        </div>
                    </div>
                </div>
