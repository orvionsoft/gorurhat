...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('cows', [FrontendController::class, 'cows'])->name('cows');
    ...
    // Cow cart routes
    Route::post('cow/cart/store', [ShoppingController::class, 'addCowToCartPost'])->name('cow.cart.store');
    Route::get('/add-cow-to-cart/{id}', [ShoppingController::class, 'addCowToCartGet'])->name('cow.addToCart');
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::get('contact-message/manage', [ContactMessageController::class,'index'])->name('contact-message.index');
    Route::get('contact-message/{id}', [ContactMessageController::class,'show'])->name('contact-message.show');
    Route::post('contact-message/destroy', [ContactMessageController::class,'destroy'])->name('contact-message.destroy');
    ...
    // Cows route
    Route::redirect('cows', 'cows/manage');
    Route::get('cows/manage', [CowsController::class,'index'])->name('cows.index');
    Route::get('cows/create', [CowsController::class,'create'])->name('cows.create');
    Route::post('cows/save', [CowsController::class,'store'])->name('cows.store');
    Route::get('cows/{id}/edit', [CowsController::class,'edit'])->name('cows.edit');
    Route::post('cows/update/{id}', [CowsController::class,'update'])->name('cows.update');
    Route::post('cows/destroy', [CowsController::class,'destroy'])->name('cows.destroy');
    Route::post('cows/image-upload', [CowsController::class,'uploadImage'])->name('cows.image.upload');
    Route::delete('cows/image/{id}', [CowsController::class,'deleteImage'])->name('cows.image.delete');
    Route::get('cows/images/{cowId}', [CowsController::class,'getImages'])->name('cows.images');
    ...
    // footer route
    Route::get('footer/manage', [FooterController::class,'index'])->name('footer.index');
    Route::get('footer/create', [FooterController::class,'create'])->name('footer.create');
    Route::post('footer/save', [FooterController::class,'store'])->name('footer.store');
    ...
    Route::post('footer/inactive', [FooterController::class,'inactive'])->name('footer.inactive');
    Route::post('footer/active', [FooterController::class,'active'])->name('footer.active');
    Route::post('footer/destroy', [FooterController::class,'destroy'])->name('footer.destroy');
