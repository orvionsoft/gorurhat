      ...
      ">
          ...
          ">
              <a href="<?php echo e(route('dashboard')); ?>" style="display:flex; align-items:center;">
                  <img src="<?php echo e(asset(optional($generalsetting)->dark_logo ?: 'public/backEnd/assets/images/logo-dark.png')); ?>" alt="<?php echo e(optional($generalsetting)->name ?: 'Dashboard Logo'); ?>" height="40" style="max-width: 220px; object-fit: contain;">
              </a>
          </div>
          ...
          ">
              <h1 style="
                  ...
                  font-weight: 700;
              ">
                  স্বাগতম, <?php echo e(Auth::user()->name); ?>
              ...
              <div style="display: flex; align-items: center; gap: 25px;">
                  ...
                  <div class="dropdown notification-list topbar-dropdown">
                      ...
                      ">
                          <img src="<?php echo e(asset(Auth::user()->image)); ?>" alt="user-image" class="rounded-circle" style="width: 100%; height: 100%; object-fit: cover;" />
                      </a>
