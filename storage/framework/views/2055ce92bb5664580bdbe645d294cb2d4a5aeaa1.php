                        ...
                        <tr>
                            ...
                            <td>
                                <div class="custom-btn-list">
                                    <a href="<?php echo e(route('contact-message.show', $message->id)); ?>" title="View"><i class="fe-eye"></i></a>
                                    <form method="post" action="<?php echo e(route('contact-message.destroy')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" value="<?php echo e($message->id); ?>" name="hidden_id">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\orvionshop3\resources\views/backEnd/contact_message/index.blade.php ENDPATH**/ ?>