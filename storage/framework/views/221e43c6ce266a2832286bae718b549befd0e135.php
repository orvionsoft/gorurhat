                    ...
                    <form id="checkout-form" action="<?php echo e(route('customer.ordersave')); ?>" method="POST" data-parsley-validate="">
                        ...
                        <div class="card">
                           <div class="card-header">
                                <h6>আপনার অর্ডারটি কনফার্ম করতে তথ্যগুলো পূরণ করে <span style="color:#7a7878;">"অর্ডার করুন"</span> বাটন এ ক্লিক করুন অথবা ফোনে অর্ডার করতে এই নাম্বার <a href="tel:<?php echo e($contact->hotline); ?>"><?php echo e($contact->hotline); ?></a> এর উপরে ক্লিক করুন।   </h6>
                ...
                <div class="cart_details table-responsive-sm">
                    <div class="card">
                        ...
                        <div class="card-footer" style="color: black;">
                            <style>.card-footer a { color: #0a0a0a !important; }</style>
