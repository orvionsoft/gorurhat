        ...
        <div style="flex: 1; display: flex; flex-direction: column; gap: 20px;">
            ...
            <div style="background: white; padding: 25px; border-radius: 10px; display: flex; align-items: center; gap: 20px; border-bottom: 3px solid #fdf2f2;">
                ...
                <div>
                    ...
                    <div style="color: #c00000; font-weight: bold; margin-top: 5px;"><?php echo e($contact->hotline ?? '+৮৮০ ১২৩৪৫৬৭৮৯০'); ?></div>
                </div>
            </div>
            ...
            <div style="background: #c00000; padding: 25px; border-radius: 10px; color: white; position: relative; overflow: hidden;">
                ...
                <a href="https://wa.me/<?php echo e(str_replace(['+', ' ', '-'], '', $contact->hotline ?? '8801234567890')); ?>" target="_blank" style="background: #25d366; color: white; border: none; padding: 12px 20px; border-radius: 5px; font-weight: bold; cursor: pointer; display: inline-flex; align-items: center; gap: 10px; text-decoration: none;">
            ...
            <div style="background: white; padding: 25px; border-radius: 10px; display: flex; align-items: center; gap: 20px; border-bottom: 3px solid #fdf2f2;">
                ...
                <div>
                    ...
                    <div style="color: #666; font-size: 14px; margin-top: 5px; line-height: 1.4;">
                        <?php echo e($contact->address ?? 'হেড অফিস: বাসা-১২৩, ব্লক-বি, বনানী, ঢাকা-১২১৩, বাংলাদেশ।'); ?>
            ...
            <form action="<?php echo e(route('contact')); ?>" method="POST">
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 20px;">
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="name" placeholder="পুরো নাম লিখুন" value="<?php echo e(old('name')); ?>" style="width: 100%; padding: 12px; border: none; background: #f9f9f9; border-bottom: 2px solid #eee; box-sizing: border-box; border-radius: 4px;" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="phone" placeholder="+৮৮০" value="<?php echo e(old('phone')); ?>" style="width: 100%; padding: 12px; border: none; background: #f9f9f9; border-bottom: 2px solid #eee; box-sizing: border-box; border-radius: 4px;" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="email" name="email" placeholder="your@email.com" value="<?php echo e(old('email')); ?>" style="width: 100%; padding: 12px; border: none; background: #f9f9f9; border-bottom: 2px solid #eee; box-sizing: border-box; border-radius: 4px;" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="subject" placeholder="বিষয় লিখুন" value="<?php echo e(old('subject')); ?>" style="width: 100%; padding: 12px; border: none; background: #f9f9f9; border-bottom: 2px solid #eee; box-sizing: border-box; border-radius: 4px;" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <textarea name="message" placeholder="কিভাবে আমরা আপনাকে সাহায্য করতে পারি?" style="width: 100%; padding: 12px; border: none; background: #f9f9f9; border-bottom: 2px solid #eee; box-sizing: border-box; height: 120px; border-radius: 4px; resize: none;" required><?php echo e(old('message')); ?></textarea>
    ...
    <section style="background: #fdf2f2; padding: 40px 20px;">
        <div style="max-width: 1100px; margin: 0 auto; height: 350px; border-radius: 20px; position: relative; overflow: hidden; border: 8px solid white;">
            ...
            <div style="position: absolute; right: 40px; top: 50%; transform: translateY(-50%); background: white; padding: 25px; border-radius: 12px; width: 220px; text-align: center;">
                ...
                <div style="font-size: 12px; color: #777; margin-bottom: 15px;"><?php echo e($contact->address ?? 'বনানী, ঢাকা, বাংলাদেশ'); ?></div>
