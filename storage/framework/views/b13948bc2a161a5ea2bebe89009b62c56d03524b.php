...
unset($__errorArgs, $__bag); ?>" name="age" value="<?php echo e($edit_data->age); ?>" id="age" />
                <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="weight" value="<?php echo e($edit_data->weight); ?>" id="weight" />
...
unset($__errorArgs, $__bag); ?>" name="breed" value="<?php echo e($edit_data->breed); ?>" id="breed" />
...
unset($__errorArgs, $__bag); ?>" name="health" value="<?php echo e($edit_data->health); ?>" id="health" />
