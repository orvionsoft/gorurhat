        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('products.create')); ?>" class="btn btn-primary rounded-pill btn-add-cow" style="border-radius: 5px !important; background: #c00000 !important; border-color: #c00000 !important;"><i class="fe-shopping-cart"></i> Add Cows</a>
                </div>
            ...
            <div class="card-body">
                <div class="dashboard-panel-title">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <a href="<?php echo e(route('products.index')); ?>">সব পণ্য দেখুন</a>
                    </div>
                </div>
                <div class="row align-items-center mb-3">
                    <div class="col-lg-6">
                        <form class="custom_form" method="GET" action="<?php echo e(route('products.index')); ?>">
                            <div class="form-group">
                                <input type="text" name="keyword" placeholder="Search products by name, category..." value="<?php echo e(request('keyword')); ?>">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="<?php echo e(asset($value->image?$value->image->image:'')); ?>" class="backend-image" alt="<?php echo e($value->name); ?>" style="max-width: 60px; border-radius: 5px;"></td>
                            ...
                            <td>
                                <div class="button-list custom-btn-list">
                                    <a href="<?php echo e(route('products.edit',$value->id)); ?>" title="Edit" style="border-radius: 5px; border: 1px solid #c00000; color: #c00000; background: #fff;"><i class="fe-edit"></i></a>
