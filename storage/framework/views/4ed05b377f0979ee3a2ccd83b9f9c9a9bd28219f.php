...
<div class="container-fluid">
   ...
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('categories.update')); ?>" method="POST" class=row data-parsley-validate="">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="count" value="<?php echo e($edit_data->count); ?>" id="count">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\orvionshop3\resources\views/backEnd/category/edit.blade.php ENDPATH**/ ?>